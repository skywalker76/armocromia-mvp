 ...
 *
 * Server Component — nessuna interattività necessaria.
 * Layout a zig-zag con linea connettrice e stagger animation.
 */
...
const STEPS = [
  {
    ...
    description:
      "Scatta un selfie con luce naturale, senza filtri. L'AI ha bisogno di vedere i colori reali del tuo incarnato, capelli e occhi.",
    tip: "Luce naturale, sfondo neutro",
    icon: (
  ...
  {
    number: "03",
    title: "Ricevi il tuo dossier",
    description:
      "Un dossier visivo professionale con palette personalizzata, abbinamenti outfit per ogni occasione, consigli makeup e guida ai metalli ideali.",
    tip: "Scaricabile in alta qualità",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
