 ...
 */
export default function NavBar({ email, isAdmin = false }: NavBarProps) {
            ...
            <div className="relative" ref={menuRef}>
              ...
              {menuOpen && (
                <div className="absolute right-0 top-full mt-2 w-56 origin-top-right rounded-xl border border-accent/10 bg-white py-2 shadow-lg animate-slide-down">
                  ...
                  <div className="border-t border-accent/8 pt-1">
                    <DeleteAccountButton
                      className="flex w-full items-center gap-3 px-4 py-2.5 text-sm text-danger/80 transition-colors hover:bg-danger/5 hover:text-danger"
                      showIcon={true}
                    />
                  </div>
                </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 sm:hidden animate-fade-in">
          ...
          <div className="absolute inset-x-0 top-0 rounded-b-3xl bg-white shadow-xl animate-slide-down">
            ...
            {/* User info */}
            <div className="px-5 py-5 border-b border-accent/8 flex items-center justify-between gap-4">
            ...
            {/* Logout */}
            <div className="px-3 pb-5 pt-2 border-t border-accent/8 mt-1 space-y-1">
              <form action="/api/auth/logout" method="POST">
                <button
                  type="submit"
              ...
              <DeleteAccountButton
                className="flex w-full items-center gap-4 rounded-xl px-4 py-3.5 text-danger/80 transition-colors hover:bg-danger/5 hover:text-danger active:bg-danger/10"
                showIcon={true}
              />
            </div>
          </div>
