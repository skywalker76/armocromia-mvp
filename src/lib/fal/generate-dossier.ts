...
const IT: PromptStrings = {
  ...
  infografica: {
    ...
    section1EyesText: (c) => `Gli occhi ${c} si armonizzano con la palette.`,
    section1HairText: (c) => `I capelli ${c} sostengono questi toni.`,
    section1SkinText: (c) => `La pelle ${c} rende al meglio con questi colori.`,
...
const EN: PromptStrings = {
  ...
  infografica: {
    ...
    section1EyesText: (c) => `The ${c} eyes harmonize with the palette.`,
    section1HairText: (c) => `The ${c} hair supports these tones.`,
    section1SkinText: (c) => `The ${c} skin looks its best with these colors.`,
...
const ES: PromptStrings = {
  ...
  infografica: {
    ...
    section1EyesText: (c) => `Los ojos ${c} armonizan con la paleta.`,
    section1HairText: (c) => `El cabello ${c} sostiene estos tonos.`,
    section1SkinText: (c) => `La piel ${c} luce mejor con estos colores.`,
