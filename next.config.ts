...
const csp = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://lmsqueezy.com https://*.googletagmanager.com",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "img-src 'self' data: blob: https://*.supabase.co https://*.fal.run https://v3.fal.media https://*.google-analytics.com https://*.googletagmanager.com",
  "font-src 'self' data: https://fonts.gstatic.com",
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.fal.run https://*.fal.ai https://queue.fal.run https://v3.fal.media https://vitals.vercel-insights.com https://*.ingest.de.sentry.io https://*.sentry.io https://lmsqueezy.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com",
